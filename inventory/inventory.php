...
// dengan menggunakan LIMIT data sesuai dengan (awal mulai data, total data perhalaman yg ditampilkan)
$inventory = query("SELECT * FROM barang_masuk ORDER BY id DESC LIMIT $awal_data, $jumlahDataPerHalaman");

// VARIABLE TOP DATA
$qty = query("SELECT SUM(stok) AS Qty FROM barang_masuk");
$supplier = query("SELECT COUNT(DISTINCT pengrajin) AS supp FROM barang_masuk");
        ...
        <div class="row g-0 mx-5 mt-3 rounded-2 container-fluid">
            <div class="col-sm-6 col-md-11 shadow-sm p-4 mb-5 rounded box">
                <div class="flex-row d-flex justify-content-evenly">
                    ...
                    <div class="sales d-flex justify-content-between align-items-center">
                        <div class="sales-img my-3">
                            <center><i class='bx bx-package text-icon first'></i></center>
                        </div>
                        <div class="sales-text ms-3">
                            <div class="frame">
                                <div class="text-sub">Total Stok Tersedia</div>
                    ...
                    <div class="revenue d-flex justify-content-between align-items-center">
                        <div class="revenue-img my-3">
                            <center><i class='bx bx-user text-icon second'></i></center>
                        </div>
                        <div class="revenue-text ms-5">
                            <div class="frame">
                                <div class="text-sub">Pengrajin Aktif</div>
                                <div class="text-number"><?php echo $supplier[0]["supp"]; ?></div>
                            </div>
                        </div>
                    </div>
                    <img src="../images/Line.png" alt="line">

                    <div class="profit d-flex justify-content-between align-items-center">
                        <div class="profit-img my-3">
                            <center><i class='bx bx-box text-icon third'></i></center>
                        </div>
                        <div class="profit-text ms-5">
                            <div class="frame">
                                <div class="text-sub">Tipe Produk</div>
                    ...
                    <div class="cost d-flex justift-content-between align-items-center">
                        ...
                        <div class="cost-text  ms-5">
                            <div class="frame">
                                <div class="text-sub">Data Masuk</div>
            ...
            <div class="container text-center btn-table">
                <div class="row row-cols-auto mb-4">
                    ...
                    <div class="delete mt-3">
                        <a onMouseOver="this.style.color='#fff'" onMouseOut="this.style.color='#9E41FB'" style="text-decoration: none; color: #9E41FB;" ; href="javascript:void(0)" class="link_delete btn-delete" onclick="delete_all()">
                    ...
                    <div class="mt-3">
                        <a href="tambahproduk.php">
                            <button class="btn-data" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                <div class="col text-button me-2">tambah</div>
                            </button>
                        </a>
                    </div>
                    <div class="mt-3">
                        <a href="javascript:void(0)" onclick="print_barcode()">
                            <button class="btn-data" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                <div class="col text-button me-2">Print Barcode</div>
                            </button>
                        </a>
                    </div>
