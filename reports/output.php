...
$con = mysqli_connect('localhost', 'root', '', 'kampoeng_radjoet');
...
$jumlahData = count(query("SELECT * FROM reports_keluar"));
...
$reports = mysqli_query($con, "SELECT * FROM reports_keluar $sub_sql ORDER BY id DESC LIMIT $awal_data, $jumlahDataPerHalaman");
            ...
            <div class="container text-center btn-table d-flex">
                <nav>
                    <div class="row row-cols-auto mb-4 text-button2">
                        <ul class="nav">
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="input.php">Data Masuk</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="">Data Keluar</a>
                            </li>
                            <li class="nav-item">
